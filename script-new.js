const uiTranslations = {
    en: {
        ...
        footerThanks: "Made with love. Special thanks to my wonderful husband, two amazing daughters, and Gemini. Without them, this journey wouldn't be possible. 🚀✨",
    ...
    ru: {
        ...
        footerThanks: "Сделано с любовью. Особая благодарность моему замечательному мужу, двум прекрасным дочерям и Gemini. Без них это путешествие было бы невозможно. 🚀✨",
    ...
    sr: {
        ...
        footerThanks: "Napravljeno sa ljubavlju. Posebno hvala mom divnom mužu, dvema neverovatnim ćerkama i Gemini-ju. Bez njih ovo putovanje ne bi bilo moguće. 🚀✨",
